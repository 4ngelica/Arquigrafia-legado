...
<text transform="matrix(1.0338 0 0 1 42.2119 27.9512)" fill="#010101" font-family="'Roboto'" font-size="32.453"><a href="{{ URL::to("/home") }}" >ARQUIGRAFIA</a></text>
...
<form id="tfnewsearch" action="{{ URL::to("/") }}/search" method="get" accept-charset="UTF-8" target="_blank">	
