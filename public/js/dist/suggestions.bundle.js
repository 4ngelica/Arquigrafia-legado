...
var _jbox = __webpack_require__(5);
...
var _MathController = __webpack_require__(0);

var _MathController2 = _interopRequireDefault(_MathController);

var _SuggestionController = __webpack_require__(3);
...
var SuggestionModal = function () {
  ...
  _createClass(SuggestionModal, [{
    ...
    value: function getContentHTML(type, name, question) {
      ...
      var contentHTML = templateContent({ name: name, question: question });
    ...
    value: function getFooterHTML(type, currentIndex) {
      ...
      if (type === 'confirm') {
        var sourceFooter = (0, _jquery2.default)("#suggestion-modal-confirm-footer").html();
      } else if (type === 'jump') {
        var sourceFooter = (0, _jquery2.default)("#suggestion-modal-jump-footer").html();
      } else if (type === 'lastPage') {
        var sourceFooter = (0, _jquery2.default)("#suggestion-modal-close-footer").html();
      }
      var templateTitle = Handlebars.compile(sourceFooter);
      var footerHTML = templateTitle({ percentage: percentage });
...
var _SuggestionModal = __webpack_require__(2);
