...
var _MathController = __webpack_require__(2);
...
var SuggestionModal = function () {
  function SuggestionModal(missingFields) {
      ...
      this.suggestionModals[currentIndex.toString()] = new jBox('Modal', {
        ...
        onCreated: function () {
          ...
          $('.enviar-button').on('click', function () {
            ...
            // Sending suggestion
            _SuggestionController2.default.sendSuggestion(user.id, photo.id, _this.missingFields[currentIndex].attribute_type, suggestionText);
          ...
          $('.sim-button').on('click', function () {
            // Sending suggestion
            _SuggestionController2.default.sendSuggestion(user.id, photo.id, _this.missingFields[currentIndex].attribute_type, _this.missingFields[currentIndex].field_content);
            // Change page (go to the next modal)
            _this.changePage(currentIndex);
          }.bind(_this));
...
var _SuggestionModal = __webpack_require__(0);
...
(0, _jquery2.default)(document).ready(function () {
  ...
  (0, _jquery2.default)('#OpenModal').click(function () {
    ...
    if (missingFields && missingFields.length > 0) {
      var suggestionModal = new _SuggestionModal2.default(missingFields);
